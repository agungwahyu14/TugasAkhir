                ...
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1 flex items-center justify-between">
                            ...
                            <router-link to="/admin/naskah/tambah-naskah-keluar"
                    ...
                    <table class="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td
                                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">
                                    <router-link to="/admin/naskah/edit-naskah-keluar"
...
<script>
// import ButtonModalArsip from "@/components/Modals/ButtonModalArsip.vue";
