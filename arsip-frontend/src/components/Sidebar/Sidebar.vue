      ...
      <div
        ...
        <ul class="md:flex-col md:min-w-full flex flex-col list-none">
          <li class="items-center">
            <router-link to="/admindashboard" v-slot="{ href, navigate, isActive }">
          ...
          <li class="items-center">
            <router-link to="/admin/berkas-arsip" v-slot="{ href, navigate, isActive }">
              <a :href="href" @click="navigate" class="text-xs uppercase py-3 font-bold block" :class="[
                isActive
                  ? 'text-emerald-500 hover:text-emerald-600'
                  : 'text-blueGray-700 hover:text-blueGray-500',
              ]">
                <i class="fas fa-folder-tree mr-2 text-sm" :class="[isActive ? 'opacity-75' : 'text-blueGray-300']"></i>
                Berkas Arsip
              </a>
            </router-link>
          </li>
...
import ArsipDropdown from "@/components/Dropdowns/ArsipDropdown.vue";
import DataUserDropdown from "@/components/Dropdowns/DataUserDropdown.vue";
